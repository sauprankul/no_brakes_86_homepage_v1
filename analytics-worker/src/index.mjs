import { analyticsCollectionAllowed, originAllowed, validEvents } from './collector.mjs';
...
export default {
  async fetch(request, env) {
    ...
    if (!analyticsCollectionAllowed(request)) return new Response(null, { status: 204, headers: cors(allowedOrigin) });
