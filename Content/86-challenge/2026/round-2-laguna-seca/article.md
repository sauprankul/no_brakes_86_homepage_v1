...
- **Track:** Laguna Seca
- **Weather:** Dry
- **Official result:** [86 Challenge Stock results](https://86challenge.us/events/mar-14-2026-laguna-seca#stock)

### Stock top 5

| Pos. | Driver | Raw time | Adjusted time | Delta |
| --- | --- | --- | --- | --- |
| 1 | Ivan Larionov | 1:46.175 | 1:48.675 | — |
| 2 | Saurabh Kulkarni | 1:46.497 | 1:48.997 | +0.322 |
| 3 | Alex Deynega | 1:47.259 | 1:49.759 | +1.084 |
| 4 | Brandon Stitt | 1:47.768 | 1:50.268 | +1.593 |
| 5 | Aris Perez | 1:49.215 | 1:51.715 | +3.040 |
...
The data from last round said that my car was really touchy on the throttle. It wasn't really "oversteery" per-se, just unable to put down power. So in addition to changing my driving style, I tried using a different differential fluid - Redline 75w90NS instead of the Motul Gear 300 I had previously. It was pretty old anyway...
